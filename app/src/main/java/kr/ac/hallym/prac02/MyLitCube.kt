...
//    private val lightDir = floatArrayOf(1.0f, 1.0f, 0.0f) // 오른쪽 위
//    private val lightDir = floatArrayOf(-1.0f, 1.0f, 0.0f) // 왼쪽 위
//    private val lightDir = floatArrayOf(0.0f, 1.0f, 0.0f) // 정면 위
//    private val lightDir = floatArrayOf(0.0f, -1.0f, 0.0f) // 정면 아래
    ...
    private val matShininess = 10f
//    private val matShininess = 1.0f // 빛이 커짐
//    private val matShininess = 100.0f // 빛이 작아짐
    ...
    init {
        val vertexShader: Int = loadShader(GLES30.GL_VERTEX_SHADER, "light_uniform_color_vert.glsl", myContext)
        val fragmentShader: Int = loadShader(GLES30.GL_FRAGMENT_SHADER, "light_uniform_color_frag.glsl", myContext)
