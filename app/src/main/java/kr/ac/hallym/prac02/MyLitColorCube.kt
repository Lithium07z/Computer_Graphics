...
class MyLitColorCube(val myContext: Context) {
    ...
    init {
        val vertexShader: Int = loadShader(GLES30.GL_VERTEX_SHADER, "light_color_vert.glsl", myContext)
        val fragmentShader: Int = loadShader(GLES30.GL_FRAGMENT_SHADER, "light_color_frag.glsl", myContext)
